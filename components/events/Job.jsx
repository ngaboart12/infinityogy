...
const Job = () => {
  ...
  return (
    <div className="md:px-24 px-4 py-10 flex flex-col gap-2  ">
      ...
      />
      <h1 className="text-center text-black text-[32px] py-4">
          ...
          <div className="flex flex-col gap-2 w-full">
            {jobOffers.map((jobOffer) => (
              <div
                ...
                className="cursor-pointer hover:bg-gray-300/80 flex fle-col items-center justify-between bg-slate-200 p-2 rounded-md px-2 w-full"
              >
                <div className="flex flex-col md:flex-row w-full md:w-[40] gap-4 items-center">
                  ...
                  <div className="flex flex-col">
                    <h1 className="text-xl font-[400] text-black/80 text-center md:text-start">
                    Professional Software Development Training Program
                    </h1>
                    <div className="flex flex-row gap-4 text-black/80">
                      <span>At infinity Tech Solution</span>
