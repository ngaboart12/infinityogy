  ...
  return (
    <div className=" relative " id="contactus">
      <div className="w-full relative flex px-2 sm:px-20 py-0 bg-[#56697A] justify-center">
        ...
        <div className="padding-container max-container flexCenter flex z-40 flex-col w-full py-20 md:p-10 gap-10 bg-transparent items-start md:items-center md:justify-center">
